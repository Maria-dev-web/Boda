// ===== CONTADOR REGRESIVO =====
const fechaEvento = new Date("September 30, 2025 12:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const casaComidas = [37.203637, -3.639956];
  ...
  const marcadores = [
    ...
    { pos: casaComidas, num: 3, texto: "<b>3. Casa Comidas</b><br>(Celebración)" }
  ];
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          // Actualiza el modal según la respuesta afirmativa o negativa
